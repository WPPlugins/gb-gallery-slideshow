...
function gb_gallery_load_admin () {
    ...
    add_menu_page(__("GB Gallery"),__("GBGallery admin"), 'manage_options', 'gb-gallery-slideshow/admin/GBgallery-admin.php', '', plugins_url( 'gb-gallery-slideshow/images/admin-icon.png' ) );
...
function get_group_posts(){
    ...
    if(isset($_POST['selected_group'])){
        ...
        $my_group = $wpdb->get_results( $wpdb->prepare("SELECT groups FROM %s WHERE id = %d",array($gb_group_table,$my_group_id)) );
        $args = array(
